...
from adas.common.profiler import Profiler
from adas.visualization.vehicle_vis import Visualizer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video", type=str, default="adas/test-video_480.mp4", help="Path to input video")
