...
def run_geometry_engine(video_path: str, estimator_type: str = "none"):
    ...
    from dimension_estimator_interface import DummyGeometryFallback, VehicleObservation
    from estimators.smoke_estimator import SMOKEEstimator
    from estimators.rtm3d_estimator import RTM3DEstimator
